...
[![User Persona Segmento 1](./assets/img/Segmento1-UserPersona.png)](./assets/img/Segmento1-UserPersona.png)

**Segmento Objetivo 2: Empresas o consorcios de transporte público**

[![User Persona Segmento 2](./assets/img/Segmento2-UserPersona.png)](./assets/img/Segmento2-UserPersona.png)
...
[![Journey Mapping Segmento 1](./assets/img/Segmento1-JourneyMapping.png)](./assets/img/Segmento1-JourneyMapping.png)


**Segmento Objetivo 2: Empresas o consorcios de transporte público**

[![Journey Mapping Segmento 2](./assets/img/Segmento2-JourneyMapping.png)](./assets/img/Segmento2-JourneyMapping.png)
...
[![Empathy Mapping Segmento 1](./assets/img/Segmento1-EmpathyMapping.png)](./assets/img/Segmento1-EmpathyMapping.png)

**Segmento Objetivo 2: Empresas o consorcios de transporte público**

[![Empathy Mapping Segmento 2](./assets/img/Segmento2-EmpathyMapping.png)](./assets/img/Segmento2-EmpathyMapping.png)
...
[![As-Is Scenario Mapping Segmento 1](./assets/img/Segmento1-As-IsMapping.png)](./assets/img/Segmento1-As-IsMapping.png)

**Segmento Objetivo 2: Empresas o consorcios de transporte público**

[![As-Is Scenario Mapping Segmento 2](./assets/img/Segmento2-As-IsMapping.png)](./assets/img/Segmento2-As-IsMapping.png)
